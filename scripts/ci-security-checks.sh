...
send_mail() {
  ...
  # Ensure nodemailer is available without failing the build or locking dependency versions
...
(async () => {
  // Enhanced path resolver checks exact path, reports/ relative path, and root path
